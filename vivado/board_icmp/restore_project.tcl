...
add_files -fileset [get_filesets sources_1] ../../util/axis_dispose.v
add_files -fileset [get_filesets sources_1] ../../toe/RTL/tcp_checksum_axis.v
add_files -fileset [get_filesets sources_1] ../../toe/RTL/checksumRed34to2.v
add_files -fileset [get_filesets sources_1] ../../toe/RTL/6to3_reducer_i.vhd
add_files -fileset [get_filesets sources_1] ../../toe/RTL/7to3_reducer_i.vhd
...
lappend ip_repo_path_list [file normalize ../../toe/synthesis_results]
